...
$bookmarks = @(
    @{Name = "Clerk ECF"; Url = "https://eflex.arcourts.gov/"}
    @{Name = "eFlex"; Url = "https://efile.arcourts.gov/"}
    @{Name = "Benton County Government"; Url = "https://bentoncountyar.gov/"}
    @{Name = "Internal Court Connect"; Url = "https://courtinfo.arcourts.gov/PRODords/f?p=129:9999:1530300918335:::::"}
    ...
    @{Name = "ADP"; Url = "https://online.adp.com/signin/v1/?APPID=WFNPortal&productId=80e309c3-7085-bae1-e053-3505430b5495&returnURL=https://workforcenow.adp.com/&callingAppId=WFN"}
)

Write-Host "============================================" -ForegroundColor Cyan
Write-Host "Criminal/Civil Bookmarks - Chrome Setup" -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan
Write-Host ""
